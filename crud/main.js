const cargarPosts = async() => {
    ...
    data.map(item => {
        ...
        <tr>
            ...
            <td>${item.title}</td>
            <td>${item.body}</td>
            <td><button class="btn btn-primary btn-lg"  data-bs-toggle="modal" data-bs-target="#editModal" onclick="cargarPost(${item.id})"><i class="bi bi-clipboard-plus m-2"></i>Editar</button></td>
            <td><button class="btn btn-danger btn-lg"  data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="eliminarPost(${item.id})"><i class="bi bi-clipboard-x-fill m-2"></i>Eliminar</button></td>
        </tr> `;
...
const addPost = async() => {
    ...
    tr.innerHTML = `
        ...
        <th scope="row">${respuesta.id}</th>
            ...
            <td><button class="btn btn-primary btn-lg"  data-bs-toggle="modal" data-bs-target="#editModal"><i class="bi bi-cart-plus m-2"></i>Editar</button></td>
